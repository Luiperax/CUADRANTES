...
class DialogoTrabajador(QtWidgets.QDialog):
    ...
    def __init__(self, trabajador: Trabajador | None = None, parent=None):
        ...
        self.w_finde_noche = QtWidgets.QCheckBox(
            "En fin de semana, solo de noche (si le toca finde, es nocturno)")
        self.w_finde_noche.setChecked(self.trabajador.finde_solo_noche)
        ...
        self.w_absorbe.setToolTip(
            "Queda fuera del equilibrio de horas y nunca se le asignan menos que a "
            "un compañero. Así el sobrante que no se puede repartir a partes iguales "
            "recae siempre en él, y el resto queda parejo.")
