...
class PanelConfiguracion(QtWidgets.QDialog):
    ...
    def _pestana_general(self) -> QtWidgets.QWidget:
        ...
        self.w_comunidad = QtWidgets.QLineEdit(self.config.comunidad_autonoma)
        self.w_municipio = QtWidgets.QLineEdit(self.config.municipio)
        ...
        f.addRow("Comunidad autónoma (festivos):", self.w_comunidad)
        f.addRow("Municipio (festivos locales):", self.w_municipio)
    ...
    def configuracion_resultante(self) -> Configuracion:
        ...
        c.comunidad_autonoma = self.w_comunidad.text()
        c.municipio = self.w_municipio.text()
